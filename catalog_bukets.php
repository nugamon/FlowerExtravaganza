...
<body id="catalog">
    ...
    $page_url = "catalog_bukets.php?category_id={$category_id}&";
    ...
    <section id="cards" class="bg-light" style="padding-top:40px">
        ...
        // Выбираем товары только этой категории!
        $stmt = $product->readAll($start_from, $records_per_page, $category_id);

        if ($stmt->rowCount() > 0) {
            echo "<div class='container-xxl'><div class='row'>";
            ...
            // Пагинация работает корректно, если $total_rows и $page_url правильные
